...
import img21 from '../../Images/Hero_Images/photo_21.jpg';
import img22 from '../../Images/Hero_Images/photo_22.jpg';
import img23 from '../../Images/Hero_Images/photo_23.jpg';
    ...
    <div className="hero17-header78 font-sans">
      <div className="hero17-column thq-section-padding thq-section-max-width">
        ...
        <div className="hero17-actions">
          <button 
          className="thq-button-filled hero17-button1 hover:border-none"
